...
const site = {
  id: '53bb819a-4203-4c5a-aad8-057f421f59b1',
  clientId: '3e2fd0ad-93f1-4c51-a8ea-2f45f08e0f10',
  clientName: 'Industria Atlas',
  name: 'Unidade Centro',
  description: null,
  address: null,
  city: 'Sao Paulo',
...
const equipment = {
  id: 'e162020b-afaf-4795-8263-54b36488e775',
  siteId: site.id,
  siteName: site.name,
  clientId: site.clientId,
  name: 'Compressor XPTO',
  assetNumber: 'PAT-001',
  serialNumber: 'SN-001',
  manufacturer: 'Atlas',
  model: 'XPTO',
...
beforeEach(() => window.localStorage.setItem('fieldops:access-token', 'supervisor-token'))
afterEach(cleanup)
  ...
  it('lists equipment and sends site and lifecycle filters to the server', async () => {
    ...
    await waitFor(() => {
      const calls = fetchMock.mock.calls
        ...
        .filter((url) => url.includes('/api/v1/equipment?'))
