...
describe('TemplateBuilderPage sections', () => {
        ...
        jsonResponse(
          {
            id: 13,
            title: 'Funcionamento',
            description: 'Testes operacionais',
            displayOrder: 3,
          },
          201,
        ),
  ...
  it('reorders, edits, and confirms deletion through the API', async () => {
    const fetchMock = vi
      ...
      .mockResolvedValueOnce(
        jsonResponse({ id: 11, title: 'Seguranca editada', description: 'Nova descricao', displayOrder: 2 }),
      )
    ...
    await waitFor(() =>
      expect(fetchMock).toHaveBeenLastCalledWith(
        expect.stringContaining('/sections/11'),
    ...
    const fetchMock = vi
      ...
      .mockResolvedValueOnce(
        jsonResponse(
          {
            id: 21,
            title: 'Estado da placa',
            description: 'Verifique danos',
    ...
    const fetchMock = vi
      ...
      .mockResolvedValueOnce(
        jsonResponse(
          {
            id: 23,
            title: 'Cabos eletricos integros?',
            description: null,
...
function renderBuilder() {
  render(
    <MemoryRouter initialEntries={['/app/inspection-templates/42/edit']}>
      <Routes>
