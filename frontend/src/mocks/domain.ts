...
export const clients: Client[] = [
  {
    id: 'cli-industria',
    name: 'Industria Modelo',
    document: '12.345.678/0001-90',
    email: 'operacoes@industriamodelo.com.br',
    active: true,
    siteIds: ['site-sorocaba', 'site-sp'],
  },
  {
    id: 'cli-logistica',
    name: 'Logistica ABC',
    document: '23.456.789/0001-10',
    email: 'manutencao@logisticaabc.com.br',
    active: true,
    siteIds: ['site-campinas'],
  },
  {
    id: 'cli-delta',
    name: 'Comercial Delta',
    document: '34.567.890/0001-22',
    email: 'facilities@delta.com.br',
    active: true,
    siteIds: [],
  },
  {
    id: 'cli-horizonte',
    name: 'Metalurgica Horizonte',
    document: '45.678.901/0001-33',
    email: 'seguranca@horizonte.com.br',
    active: false,
    siteIds: ['site-jundiai'],
  },
]
...
export const sites: Site[] = [
  ...
  },
  {
    ...
    city: 'Sao Paulo',
    state: 'SP',
    contact: 'Marcos Alves',
    active: true,
  },
  {
    id: 'site-jundiai',
    name: 'Centro Operacional Jundiai',
...
export const equipment: Equipment[] = [
  {
    id: 'eq-compressor',
    name: 'Compressor XPTO 500',
    patrimony: 'CMP-500',
    serialNumber: 'XPTO-500-2024-019',
  ...
  {
    id: 'eq-gerador',
    name: 'Gerador Diesel GD-002',
    patrimony: 'GD-002',
    serialNumber: 'GD002-88912',
  ...
  },
  {
    id: 'eq-extintor',
    name: 'Extintor P12',
    patrimony: 'EXT-P12-044',
    serialNumber: 'EXT-044-2026',
    siteId: 'site-sp',
    qrCode: 'FO-EXT-P12-044',
    active: true,
  },
  {
    id: 'eq-empilhadeira',
...
export const compressorSections = [
  {
    ...
    items: [
      {
        id: 'item-1',
        question: 'A placa de identificacao esta legivel?',
        responseType: ResponseType.CONFORMITY,
        required: true,
        requireObservationOnFailure: true,
        requireEvidenceOnFailure: true,
      },
      {
        id: 'item-2',
        question: 'Equipamento limpo e conservado?',
        responseType: ResponseType.CONFORMITY,
        required: true,
        requireObservationOnFailure: true,
        requireEvidenceOnFailure: true,
      ...
      {
        id: 'item-3',
        question: 'Estrutura externa sem danos?',
  ...
  },
  {
    ...
    items: [
      {
        id: 'item-4',
        question: 'Protecoes das partes moveis instaladas?',
        responseType: ResponseType.CONFORMITY,
        required: true,
        requireObservationOnFailure: true,
        requireEvidenceOnFailure: true,
      ...
      {
        id: 'item-5',
        question: 'Etiquetas de advertencia visiveis?',
        responseType: ResponseType.CONFORMITY,
        required: true,
        requireObservationOnFailure: true,
        requireEvidenceOnFailure: true,
      ...
      {
        id: 'item-6',
        question: 'Botao de emergencia funcionando?',
        responseType: ResponseType.SINGLE_CHOICE,
        required: true,
        requireObservationOnFailure: true,
        requireEvidenceOnFailure: false,
        options: ['Funcionando', 'Intermitente', 'Nao funcionando'],
      },
    ],
  },
  {
    id: 'sec-eletrico',
    title: 'Sistema Eletrico',
    items: [
      {
        id: 'item-7',
        question: 'Cabos eletricos integros?',
        responseType: ResponseType.CONFORMITY,
        required: true,
        requireObservationOnFailure: true,
        requireEvidenceOnFailure: true,
      ...
      {
        id: 'item-8',
        question: 'Conexoes sem sinais de aquecimento?',
        responseType: ResponseType.CONFORMITY,
        required: true,
        requireObservationOnFailure: true,
        requireEvidenceOnFailure: true,
      ...
      {
        id: 'item-9',
        question: 'Resistencia do aterramento?',
        description: 'Informar resistencia em ohms.',
  ...
  },
  {
    ...
    items: [
      {
        id: 'item-10',
        question: 'Pressao dentro da faixa?',
        responseType: ResponseType.NUMBER,
        required: true,
        requireObservationOnFailure: true,
        requireEvidenceOnFailure: false,
      ...
      {
        id: 'item-11',
        question: 'Vibracao dentro do limite?',
        responseType: ResponseType.CONFORMITY,
        required: true,
        requireObservationOnFailure: true,
        requireEvidenceOnFailure: true,
      ...
      {
        id: 'item-12',
        question: 'Equipamento operando sem ruidos anormais?',
        responseType: ResponseType.TEXT_SHORT,
        required: false,
        requireObservationOnFailure: false,
        requireEvidenceOnFailure: false,
      },
...
export const templates: InspectionTemplate[] = [
  {
    ...
    category: 'Manutencao',
    description: 'Checklist preventivo para compressores industriais.',
    version: 3,
    status: 'Ativa',
    sections: compressorSections,
  },
  {
    id: 'tpl-extintor',
    title: 'Inspecao de Extintor',
    category: 'Seguranca',
    description: 'Verificacao periodica de extintores portateis.',
    version: 2,
    status: 'Ativa',
    sections: compressorSections.slice(0, 3),
  },
  {
    id: 'tpl-gerador',
    title: 'Checklist Gerador Diesel',
    category: 'Energia',
    description: 'Inspecao operacional de geradores diesel.',
    version: 1,
    status: 'Rascunho',
    sections: compressorSections.slice(1),
  },
]
...
export const nonConformities: NonConformity[] = [
  ...
  {
    id: 'nc-etiqueta',
    title: 'Etiqueta de seguranca danificada',
    inspectionId: 'ins-compressor',
    item: 'Etiquetas de advertencia visiveis?',
    clientId: 'cli-industria',
  ...
  {
    id: 'nc-vibracao',
    title: 'Vibracao acima do padrao',
    inspectionId: 'ins-compressor',
    item: 'Vibracao dentro do limite?',
    clientId: 'cli-industria',
