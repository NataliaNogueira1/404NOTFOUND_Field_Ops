...
const navigation = [
  {
    ...
    items: [
      ...
      { label: 'Inspecoes', to: '/app/inspections', icon: ClipboardCheck },
    ],
  },
  {
    label: 'OPERACOES',
    items: [
      { label: 'Modelos de inspecao', to: '/app/inspection-templates', icon: ClipboardList },
      { label: 'Nao conformidades', to: '/app/non-conformities', icon: TriangleAlert },
    ],
  },
  {
    label: 'CADASTROS',
    items: [
      ...
      { label: 'Usuarios', to: '/app/users', icon: Users, adminOnly: true },
    ],
  },
