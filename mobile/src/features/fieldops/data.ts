...
export const initialInspections: Inspection[] = [
  { id: 'ins-compressor', title: 'Inspeção Preventiva — Compressor XPTO 500', templateId: 'tpl-compressor', clientId: 'cli-industria', siteId: 'site-sorocaba', equipmentId: 'eq-compressor', technicianId: 'usr-carlos', supervisorId: 'usr-marina', status: InspectionStatus.ASSIGNED, priority: Priority.HIGH, dueDate: '2026-08-13', dueTime: '09:00', createdAt: '2026-08-10', progress: 0, syncStatus: 'pending', pendingSyncCount: 3, supervisorInstructions: 'Verificar condição da bateria com atenção especial. Último relatório indicou corrosão.' },
  { id: 'ins-gerador', title: 'Inspeção Gerador Diesel', templateId: 'tpl-compressor', clientId: 'cli-logistica', siteId: 'site-campinas', equipmentId: 'eq-gerador', technicianId: 'usr-carlos', supervisorId: 'usr-marina', status: InspectionStatus.ASSIGNED, priority: Priority.MEDIUM, dueDate: '2026-08-14', dueTime: '14:00', createdAt: '2026-08-11', progress: 0, syncStatus: 'synced', pendingSyncCount: 0, supervisorInstructions: 'Validar nível de combustível e resposta em carga.' },
  { id: 'ins-extintor', title: 'Inspeção Extintor P12', templateId: 'tpl-compressor', clientId: 'cli-industria', siteId: 'site-sp', equipmentId: 'eq-extintor', technicianId: 'usr-carlos', supervisorId: 'usr-marina', status: InspectionStatus.REJECTED, priority: Priority.LOW, dueDate: '2026-08-12', dueTime: '11:30', createdAt: '2026-08-09', progress: 84, overdue: true, syncStatus: 'error', pendingSyncCount: 1, supervisorInstructions: 'Corrigir evidência do lacre e reenviar.' },
  { id: 'ins-empilhadeira', title: 'Inspeção Empilhadeira 01', templateId: 'tpl-compressor', clientId: 'cli-horizonte', siteId: 'site-jundiai', equipmentId: 'eq-empilhadeira', technicianId: 'usr-carlos', supervisorId: 'usr-marina', status: InspectionStatus.IN_PROGRESS, priority: Priority.CRITICAL, dueDate: '2026-08-13', dueTime: '16:00', createdAt: '2026-08-12', progress: 58, syncStatus: 'pending', pendingSyncCount: 2, supervisorInstructions: 'Priorizar verificação de freio e sinais sonoros.' },
];
